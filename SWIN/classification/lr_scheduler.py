...
Changes:
    ...
    * Modified arguments:
        - t_mul=1. -> cycle_mul=1.
          The argument t_mul is renamed to cycle_mul in timm=1.0.11. This inference is made based on the snippet in timm
          repository (Accessed on 2024-10-29) which is shown below.
