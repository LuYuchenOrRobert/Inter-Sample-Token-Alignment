...
References:
    * https://github.com/microsoft/CvT/blob/main/lib/config/default.py

Changes:
    * Changed positions:
        - None
    * Added arguments:
        - config keys: ISTA2 and its child keys: to pass the arguments to ISTA2 class.
...
# ISTA2 related params
_C.MODEL.ISTA2 = CN()
_C.MODEL.ISTA2.QK_NORM = False
_C.MODEL.ISTA2.V_NORM = False
_C.MODEL.ISTA2.NORM_TYPE = 'rmsnorm'
_C.MODEL.ISTA2.ISTA2_METHOD = None
_C.MODEL.ISTA2.ATTN_INTER_TOPK = 0
_C.MODEL.ISTA2.REP_TKN_TYPE = None
_C.MODEL.ISTA2.REP_TKN_RATIO = None
# CLS_TKN_IDX and BG_TKN_IDX are defined in the model
# _C.MODEL.ISTA2.CLS_TKN_IDX = None
# _C.MODEL.ISTA2.BG_TKN_IDX = None
_C.MODEL.ISTA2.BS_RATIO = None
_C.MODEL.ISTA2.ACROSS_GPUS = False
